...
public class GLView extends GLSurfaceView {
    ...
    private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
        ...
        public EGLConfig chooseConfig(EGL10 egl10, EGLDisplay eglDisplay) {
            ...
            egl10.eglChooseConfig(eglDisplay, s_configAttribs2, null, 0, num_config);
            ...
            egl10.eglChooseConfig(eglDisplay, s_configAttribs2, configs, numConfigs, num_config);

            if (DEBUG) {
                printConfigs(egl10, eglDisplay, configs);
            }
            /* Now return the "best" one
             */
            return chooseConfig(egl10, eglDisplay, configs);
        }
